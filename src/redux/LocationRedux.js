...
const currentLocationReducer = (state = initalSavedLocation, action) => {
  ...
  switch (type) {
    ...
    //   return {
    //     ...state,
    //     hasGeolocationPermission: action.permission,
    //   };
...
export const reducer = combineReducers({settingModalReducer, languageReducer,locationAdressReducer,currentLocationReducer});
